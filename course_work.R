...
cor_tbl
vars = row.names(cor_tbl)[cor_tbl$co2_flux^2 > .1] %>% na.exclude # Берем только те имена переменных для которых значения коэффициента детерминации было больше 0,1
vars
